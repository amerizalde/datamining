...
if __name__ == "__main__":
    import Consumer
    Hailey = Consumer.Consumer("Hailey")
    Veronica = Consumer.Consumer("Veronica")
    Jordyn = Consumer.Consumer("Jordyn")
    Angelica = Consumer.Consumer("Angelica")
    Bill = Consumer.Consumer("Bill")
    Chan = Consumer.Consumer("Chan")
    Dan = Consumer.Consumer("Dan")
    Sam = Consumer.Consumer("Sam")
